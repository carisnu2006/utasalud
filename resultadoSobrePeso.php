    ...
    <div class="easyui-navpanel">
        ...
        <div class="easyui-tabs" data-options="tabHeight:60,fit:true,tabPosition:'bottom',border:false,pill:true,narrow:true,justified:true">
            <div style="padding:10px">
                ...
                <div class="m-toolbar">
                        <img src="imagenes/salud/SOBRE PESO/1 GENERALIDADES/R-NUTRICIONALES.jpg" style="margin:0;width:70%;height:40%;"> 
            ...
            <div title="Carbohidratos" style="padding:10px">
                <img src="imagenes/salud/SOBRE PESO/2 ALIMENTACION/CARBOHIDRATOS/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
            </div>
            <div title="Grasas" style="padding:10px">
                <img src="imagenes/salud/SOBRE PESO/2 ALIMENTACION/GRASAS/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
            </div>
            <div title="Proteinas" style="padding:10px">
                <img src="imagenes/salud/SOBRE PESO/2 ALIMENTACION/PROTEINAS/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
             </div>
             </div>
            <style scoped>
            p{
            ...
            <div style="padding:10px">
                ...
                <img src="imagenes/salud/SOBRE PESO/3 EJERCICIO/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
            </div>
            <div style="padding:10px">
                <div class="panel-header tt-inner">
                    <img src='imagenes/TERAPIA 1.jpg'/><br>Terapia
                </div>
                <img src="imagenes/salud/SOBRE PESO/4 TERAPIA/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
            </div>
        </div>
    </div>
    <style scoped>
