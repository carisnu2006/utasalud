    ...
    <div class="easyui-navpanel">
        ...
        <div class="easyui-tabs" data-options="tabHeight:60,fit:true,tabPosition:'bottom',border:false,pill:true,narrow:true,justified:true">
            <div style="padding:10px">
                ...
                <div class="m-toolbar">
                        <img src="imagenes/salud/NORMAL/1 GENERALIDADES/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
                </div>
            </div>
            <div style="padding:10px">
                <div class="panel-header tt-inner">
            ...
            <div title="Carbohidratos" style="padding:10px">
                <img src="imagenes/salud/NORMAL/2 ALIMENTACION/CARBOHIDRATOS/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
            </div>
            <div title="Grasas" style="padding:10px">
                <img src="imagenes/salud/NORMAL/2 ALIMENTACION/GRASAS/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
            </div>
            <div title="Proteinas" style="padding:10px">
                <img src="imagenes/salud/NORMAL/2 ALIMENTACION/PROTEÍNAS/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
             </div>
             </div>
            <style scoped>
            p{
            ...
            <div style="padding:10px">
                ...
                <img src="imagenes/salud/NORMAL/3 EJERCICIO/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
            </div>
            <div style="padding:10px">
                <div class="panel-header tt-inner">
                    <img src='imagenes/TERAPIA 1.jpg'/><br>Terapia
                </div>
                <img src="imagenes/salud/NORMAL/4 TERAPIA/R-NUTRICIONALES.jpg"margin:0;width:70%;height:40%;"> 
            </div>
        </div>
    </div>
    <style scoped>
