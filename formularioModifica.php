...
<body>
    <div class="easyui-navpanel" style="position:relative;padding:20px">
        ...
        <form id="ff" class="ff"  method="POST" action="http://localhost/utaSalud/acceso.php">
...
<?php
 ...
 $select=mysqli_query($con,"select * from usuarios where email='$variable1';");
...
?>   
            ...
            <div style="margin-bottom:10px">
                    <input name="email" id="email" readonly="true" class="easyui-textbox" label="email:" prompt="Email" style="width:100%" value="<?php echo $email;?>">
            </div>

            <div style="margin-bottom:10px">
                <input name="nombre" id="nombre" class="easyui-textbox" label="Nombre:" prompt="nombre" style="width:100%" value="<?php echo $nombre;?>">
            </div>

            <div style="margin-bottom:10px">
                <input name="apellido" id="apellido" class="easyui-textbox" label="Apellido:" prompt="apellido" style="width:100%" value="<?php echo $apellido;?>">
            </div>

            
            <div style="margin-bottom:20px">
              <input id="sexo" class="easyui-combobox" name="sexo" style="width:100%;" value="<?php echo $sexo;?>" data-options="
                      valueField: 'id',
                      textField: 'sexo',
                      label: 'Sexo:',
                      labelPosition: 'top'
            ...
            <div style="margin-bottom:10px">
                    <input name="edad" id="edad" class="easyui-numberbox" label="Edad:" prompt="Ej. 31" style="width:100%" value="<?php echo $edad;?>">
            </div>
            
            <div style="margin-bottom:10px">
                <input name="peso" id="peso" class="easyui-numberbox" label="Peso:" prompt="Ej. 70 en Kilos" style="width:100%" value="<?php echo $peso;?>">
            </div>
            
            <div style="margin-bottom:10px">
                <input name="estatura" id="estatura" class="easyui-numberbox" label="Estatura:" prompt="Ej. 170 en cm" style="width:100%" value="<?php echo $estatura;?>">
            </div>

            <div style="margin-bottom:20px">
                    <input id="carrera" class="easyui-combobox" name="carrera" style="width:100%;" value="<?php echo $carrera;?>" data-options="
                            valueField: 'id',
                            textField: 'carrera',
                            label: 'Carrera:',
                            labelPosition: 'top'
      ...
      alert("La altura que ingrese debe ser positiva");
        ...
        if(peso1==""){
          ...
          if(imc<18.5){
           ...
           /* enviar_formulario();*/
              ...
              $( "#boton" ).on( "click", function() {
                  $(location).attr('href', 'resultadoBajoPeso.php?variable1=<?php echo $variable1;?>');
              });
              });  
          }
         else if(imc<25){
         ...
         /* enviar_formulario();*/
              $( document ).ready(function(){
              $( "#boton" ).on( "click", function() {
                  $(location).attr('href', 'resultadoNormal.php?variable1=<?php echo $variable1;?>');
              });
              });      
          }
          else if(imc>25){
            ...
            /*enviar_formulario();*/
              $( document ).ready(function(){
              $( "#boton" ).on( "click", function() {
                  $(location).attr('href', 'resultadoSobrePeso.php?variable1=<?php echo $variable1;?>');
              });
              });   
          }
